 ...
 **/
GPB_FINAL @interface PhoneRoot : GPBRootObject
@end

#pragma mark - Phone

typedef GPB_ENUM(Phone_FieldNumber) {
  Phone_FieldNumber_CountryCode = 1,
  Phone_FieldNumber_Number = 2,
  Phone_FieldNumber_Extension = 3,
};

GPB_FINAL @interface Phone : GPBMessage
